    ...
    <body bgcolor="whitesmoke">   
        <form action="edited.php" method="POST">
            <div align="center">
                ...
                <!--<input type="submit" width="100" value="Update All Info"><br/><br/>-->
            </div>
        <table border="0" cellpadding="5" align="center">
            ...
            <tr>
                ...
                <td>
                    <input type="date" name="date_of_birth" id="date_of_birth" value="<?php
                ...
                <td>
                    <input type="number" name="social_security_number" id="ssn" value="<?php
