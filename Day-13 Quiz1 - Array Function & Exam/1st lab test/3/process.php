...
<html>
    ...
    <head>
    <title>PHP Calculator</title></head>
    <meta name="keywords" descriptoin="">
    <meta name="keywords" content="php calculator, how to make calculator, easy php
          php calculator, 
          ">
    ...
    <body>
        <div align="center">
            <h2><a href="index.php">Click Here</a> to Calculate Again<br/></h2>
        </div>
